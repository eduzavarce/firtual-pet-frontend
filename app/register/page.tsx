        ...
        <div className="max-w-md mx-auto">
          <Card className="chunky-border border-border bg-card">
            <CardHeader className="text-center">
              <CardTitle className="font-comic text-4xl font-bold text-primary skew-slight">JOIN UGLY TOONS</CardTitle>
              <p className="text-muted-foreground font-bold">Create your account and adopt your first abomination</p>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center pt-4 border-t border-border">
                <p className="text-muted-foreground font-bold">
                  ...
                  <Link href="/login" className="text-primary hover:text-primary/80 font-bold underline">
                    Login here
                  </Link>
                </p>
              </div>
