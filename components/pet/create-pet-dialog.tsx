    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="chunky-border border-border bg-card">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {error && (
            <div className="p-3 bg-destructive/10 border border-destructive rounded text-destructive font-bold">
              {error}
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            <Select value={type} onValueChange={(value: "CAT" | "RABBIT" | "DOG" | "CANARY") => setType(value)}>
